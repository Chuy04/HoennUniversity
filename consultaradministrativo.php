<?php
    ...
    $Consultar = "SELECT * FROM administrativo";
                              ...
                              <div class="col-8">
                                <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
                                  <div class="navbar-nav d-flex flex-row ListaTitulo bg-success">
                                    <a class="nav-item nav-link active" href="../HTML/Principal.html"> Inicio </a>
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu bg-success">
                                        <a class="dropdown-item" href="../HTML/index.html">Inicio Sesión</a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table class="table mt-5">
                                    ...
                                    ?> 
                                          <tr>
                                              <td><?php echo $row['ID_Administrativo'];?></td>
                                              <td><?php echo $row['Nombre_Administrativo'];?></td>
                                              <td><?php echo $row['Puesto_Administrativo'];?></td>
                                              <td><?php echo $row['Edad_Administrativo'];?></td>
                                              <td><a class="btn btn-info" href="ModificarAdmin.php?ID_Administrativo=<?php echo $row['ID_Administrativo'];?>">
                                              Edit</a>&nbsp; <a class="btn btn-danger" href="EliminarAdmin.php?ID_Administrativo=<?php echo $row['ID_Administrativo'];?>">
                                              Delete</a>
                                              </td>
                                              <tr>
                                                <?php

                                    ...
                                    <tbody>
                                        ...
                                        ?> 
                                            <tr>
                                              ...
                                              <td><?php echo $row['Carrera_Profesor'];?></td>
                                              <td><?php echo $row['Edad_Profesor'];?></td>
                                              <td><a class="btn btn-info" href="ModificarProfesor.php?ID_Profesor=<?php echo $row['ID_Profesor'];?>">
                                              Edit</a>&nbsp; <a class="btn btn-danger" href="EliminarProfesor.php?ID_Profesor=<?php echo $row['ID_Profesor'];?>">
                                              Delete</a>
                                              </td>
                                            <tr>
                                              <?php
